namespace WanaKanaSharp
{
    public class Constants
    {
        ...
        public static string SokuonHiragana = "っ";
        public static string SokuonKatakana = "ッ";
        ...
        public static readonly Dictionary<string, string> RomajiHiraganaDictionary = new Dictionary<string, string>()
        {
            {"a", "あ"},
            {"i", "い"},
            {"u", "う"},
...
/*          {"gwa", "ぐぁ"},*/
        ...
        public static readonly Dictionary<string, string> RomajiKatakanaDictionary = new Dictionary<string, string>()
        {
            {"a", "ア"},
            {"i", "イ"},
            {"u", "ウ"},
...
/*            {"ァ", "a"},
        ...
        public static readonly Dictionary<string, string> RomajiObsoleteHiraganaDictionary = new Dictionary<string, string>()
        {
            {"wi", "ゐ"},
            {"we", "ゑ" }
        };

        public static readonly Dictionary<string, string> RomajiObsoleteKatakanaDictionary = new Dictionary<string, string>()
        {
            {"wi", "ヰ"},
            {"we", "ヱ" }
        };
